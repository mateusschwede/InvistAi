    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                foreach ($linhas as $l) {
                    $totalSobraAportes = $l['totalSobraAportes'];
                }
                ?>
                <div class="text-center">
                    ...
                    foreach ($linhas as $l) {
                        ...
                        foreach ($linhas2 as $l2) {
                            ...
                            foreach ($linhas3 as $l3) {
                                $cotacaoAtual = $l3['cotacaoAtual'];
                            }

                            if ($l2['qtdAcao'] != 0) {
                                $totalCarteiras += ($l2['qtdAcao'] * $cotacaoAtual);
                            }
                        }
                    }
                    ...
                    $linhas = $r->fetchAll(PDO::FETCH_ASSOC);
                    foreach ($linhas as $l) {
                        $totalSobras = $l['totalSobraAportes'];
                    }
